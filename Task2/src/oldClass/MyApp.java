...
public class MyApp implements DataConnection {
    ...
    public int loadDatas(int sum) throws Exception {
        //File file = new File("I:\\A.Ivanova\\Мои документы\\отчёты\\журнал.txt");
        //File file = new File("Мои документы\\Со сканера\\log.doc");
        File file = new File("журнал.txt");
        // не трогать!
        //try {
